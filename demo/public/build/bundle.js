    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h21 = element("h2");
    			h21.textContent = "Introduction";
    			t50 = space();
    			p3 = element("p");
    			t51 = text("Wonderscroll is yet another javascript library for animating css properties based on scroll values. ");
    			strong2 = element("strong");
    			strong2.textContent = "It is in early stage and many issues can still arise.";
    			t53 = space();
    			h32 = element("h3");
    			h32.textContent = "Why Wonderscroll";
    			t55 = space();
    			p4 = element("p");
    			p4.textContent = "Why not? This project exists mostly as a learning project, but its aim is to be usable in production. It is used to tween css properties between a start and finish value. It is not used to trigger css animations or transitions.";
    			t57 = space();
    			h33 = element("h3");
    			h33.textContent = "Core Concepts";
    			t59 = space();
    			p5 = element("p");
    			t60 = text("Their are 3 main objects: ");
    			strong3 = element("strong");
    			strong3.textContent = "Wonderscroll, Observer and Mutator.";
    			t62 = text(" Those three work together in order to efficiently modify an element' style. \n\t\tThe Wonderscroll object is the conductor and manages its own observer(s) and their related mutator(s). \n\t\tObservers can set their own start and end point in relation to the screen position of the element and they know which mutators to apply. \n\t\tThey track progress between those points. Mutators are responsible for the tweening logic of all properties. They get the progress from their observer and apply easing (if applicable) to output final property value.");
    			t63 = space();
    			...
    			add_location(h20, file, 76, 2, 1371);
    			...
    			attr_dev(section0, "class", "svelte-1cj4lql");
    			add_location(section0, file, 75, 1, 1341);
    			attr_dev(h21, "class", "svelte-1cj4lql");
    			add_location(h21, file, 88, 2, 2594);
    			add_location(strong2, file, 89, 122, 2738);
    			attr_dev(p3, "class", "emphasis");
    			add_location(p3, file, 89, 2, 2618);
    			attr_dev(h32, "id", "why-wonderscroll");
    			attr_dev(h32, "class", "svelte-1cj4lql");
    			add_location(h32, file, 90, 2, 2815);
    			add_location(p4, file, 91, 2, 2865);
    			attr_dev(h33, "id", "core-concepts");
    			attr_dev(h33, "class", "svelte-1cj4lql");
    			add_location(h33, file, 92, 2, 3102);
    			add_location(strong3, file, 93, 31, 3175);
    			add_location(p5, file, 93, 2, 3146);
    			attr_dev(section1, "id", "introduction");
    			attr_dev(section1, "class", "svelte-1cj4lql");
    			add_location(section1, file, 87, 1, 2564);
    			attr_dev(div, "class", "svelte-1cj4lql");
    			add_location(div, file, 100, 2, 3798);
    			attr_dev(footer, "class", "svelte-1cj4lql");
    			add_location(footer, file, 99, 1, 3787);
